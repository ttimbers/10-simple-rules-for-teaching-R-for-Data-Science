...
```{r tests-as-feedback, out.width="75%", fig.retina=2, fig.align="left"}
...
```{r 10-toy-example-clustering-1, out.width="40%", fig.retina=2}
...
```{r dsci-100-coc, out.width="78%", fig.retina=2, fig.align="left"}
...
- [UBC Master of Data Science teaching team](https://ubc-mds.github.io/team/)
