...
```{r README-example-plot-from-data-1, out.width="70%", fig.retina=2}
...
```{r dsci-100-coc, out.width="78%", fig.retina=2}
...
.pull-left[
```{r da-review-checklist-1, out.width="90%", fig.retina=2}
knitr::include_graphics("img/da-review-checklist-1.png")
```
]

.pull-right[
```{r da-review-checklist-2, out.width="90%", fig.retina=2}
...
```{r student-project, out.width="90%", fig.reztina=2}
...
Projects are central to UBC's STAT 545 founding data science course.

```{r stat-545, out.width="60%", fig.retina=2}
